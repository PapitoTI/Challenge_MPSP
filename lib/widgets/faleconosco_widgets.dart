...
class FaleConoscoIconContainer extends StatelessWidget {
  static const double boxSize = 70;

  FaleConoscoIconContainer(this.img, this.link);
...
class FaleConoscoIconTitle extends StatelessWidget {
  FaleConoscoIconTitle(this.title);
  final String title;
